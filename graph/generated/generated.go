...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		UpdateUser func(childComplexity int, id string, firstName *string, lastName *string, email *string) int
	}
...
type MutationResolver interface {
	...
	UpdateUser(ctx context.Context, id string, firstName *string, lastName *string, email *string) (*User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateUser":
		...
		return e.complexity.Mutation.UpdateUser(childComplexity, args["id"].(string), args["firstName"].(*string), args["lastName"].(*string), args["email"].(*string)), true
...
type Mutation {
  ...
  updateUser(id: ID!, firstName: String, lastName: String, email: String): User @authenticated
}`, BuiltIn: false},
}
...
func (ec *executionContext) _Mutation_updateUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().UpdateUser(rctx, fc.Args["id"].(string), fc.Args["firstName"].(*string), fc.Args["lastName"].(*string), fc.Args["email"].(*string))
		}
