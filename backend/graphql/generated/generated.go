...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateTodo        func(childComplexity int, title string, description string, dueDate time.Time) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["title"].(string), args["description"].(string), args["dueDate"].(time.Time)), true
	...
	case "Mutation.register":
		...
		return e.complexity.Mutation.Register(childComplexity, args["firstName"].(string), args["lastName"].(string), args["email"].(string), args["password"].(string)), true
...
func (ec *executionContext) _Mutation_register(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Register(rctx, fc.Args["firstName"].(string), fc.Args["lastName"].(string), fc.Args["email"].(string), fc.Args["password"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().CreateTodo(rctx, fc.Args["title"].(string), fc.Args["description"].(string), fc.Args["dueDate"].(time.Time))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			if ec.directives.Authenticated == nil {
				return nil, errors.New("directive authenticated is not implemented")
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *app/graphql/generated.Todo`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*Todo)
	fc.Result = res
	return ec.marshalOTodo2ᚖappᚋgraphqlᚋgeneratedᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Todo)
	fc.Result = res
	return ec.marshalNTodo2ᚕᚖappᚋgraphqlᚋgeneratedᚐTodoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Todo_dueDate(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Todo",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) marshalNTodo2ᚕᚖappᚋgraphqlᚋgeneratedᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2ᚖappᚋgraphqlᚋgeneratedᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTodo2ᚖappᚋgraphqlᚋgeneratedᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOTodo2ᚖappᚋgraphqlᚋgeneratedᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Todo(ctx, sel, v)
